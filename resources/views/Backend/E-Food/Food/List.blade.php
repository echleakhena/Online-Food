                    ...
                    <tr style="border-bottom: 1px solid var(--light-gray);">
                        <td style="padding: 15px 10px;">
                            <div style="display: flex; align-items: center;">
                                <img src="{{ $food->image_url }}" style="width: 50px; height: 50px; border-radius: 8px; object-fit: cover; margin-right: 10px;">
                                <div>
                                    <div style="font-weight: 600;">{{ $food->name }}</div>
                                    <div style="font-size: 13px; color: var(--gray);">#FOOD-{{ $food->id }}</div>
                                </div>
                            </div>
                        </td>
