                    ...
                    <tr style="border-bottom: 1px solid var(--light-gray);">
                        <td style="padding: 15px 10px;">
                            <div style="display: flex; align-items: center;">
                                <div style="width: 40px; height: 40px; border-radius: 8px; background: linear-gradient(135deg, #02074b, #02074b); margin-right: 10px; display: flex; align-items: center; justify-content: center; color: white;">
                                    <i class="fas fa-utensils"></i>
                                </div>
                                <div>
                                    <div style="font-weight: 600;">{{ $category->name }}</div>
                                    <div style="font-size: 13px; color: var(--gray);">CTID{{ $category->id }}</div>
                                </div>
                            </div>
                        </td>
